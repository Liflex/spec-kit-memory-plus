...
| **[Установка через AI-агента](INSTALL.md)** | **Полное руководство по установке** |
...
| [AI-агенты и скиллы](docs/agents.md) | Полуавтоматическое создание агентов, SkillsMP |
| [Безопасность скиллов](docs/security-scanning.md) | Двухуровневая система проверки скиллов |
