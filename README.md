...
- **Built-in критерии**: 4 шаблона для API, кода, документации, конфигурации
...
**Реализация**: 180 задач в 12 фазах завершено
...
### Фазы Quality Loop + Security (v0.2.0) 🆕

| Фаза | Статус | Задачи |
|------|--------|--------|
| Phase 1: Setup | ✅ Завершено | 8/8 |
| Phase 2: Foundational | ✅ Завершено | 10/10 |
| Phase 3: Criteria Templates | ✅ Завершено | 9/9 |
...
| Phase 10: Documentation | ✅ Завершено | 2/2 |
...
- **Built-in Criteria**: 4 templates for API, code, docs, config
...
Security scanning **automatically runs** when:

#### 1. Downloading skills from SkillsMP
...
# - Level 2: LLM review (if WARNING)
# - BLOCKED skills automatically deleted
```
...
# 🔍 Security scanning AUTOMATIC here!
# - Created agent scanned
# - Agent-specific threats checked
# - BLOCKED agents not saved
```
...
**Implementation**: 180 tasks across 12 phases complete
...
### Quality Loop + Security Phases (v0.2.0) 🆕

| Phase | Status | Tasks |
|-------|--------|-------|
| Phase 1: Setup | ✅ Complete | 8/8 |
| Phase 2: Foundational | ✅ Complete | 10/10 |
| Phase 3: Criteria Templates | ✅ Complete | 9/9 |
...
| Phase 10: Documentation | ✅ Complete | 2/2 |
