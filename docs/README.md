...
| [Подсистемы качества](subsystems.md) | Loop, Templates, Plans и внутренние компоненты |
| [Конфигурация](configuration.md) | Файлы конфигурации, профили приоритетов, политики |
